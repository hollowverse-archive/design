        ...
        <TextPage>
          ...
          <ol>
            <li>
              ...
              <ol type="A">
                ...
                <li>
                  ...
                  contained on Hollowverse’s web site;
                </li>
                <li>
            ...
            <li>
              ...
              these restrictions and may be terminated by Hollowverse at any
          ...
          <h2>3. Disclaimer</h2>
          <p>
            The materials on Hollowverse’s web site are provided “as is”.
            ...
            Hollowverse does not warrant or make any representations concerning
          ...
          <h2>4. Limitations</h2>
          <p>
            In no event shall Hollowverse or its suppliers be liable for any
            damages (including, without limitation, damages for loss of data or
            profit, or due to business interruption,) arising out of the use or
            inability to use the materials on Hollowverse’s Internet site, even
            if Hollowverse or a Hollowverse authorized representative has been
          ...
          <p>
            The materials appearing on Hollowverse’s web site could include
            technical, typographical, or photographic errors. Hollowverse does
            not warrant that any of the materials on its web site are accurate,
            complete, or current. Hollowverse may make changes to the materials
            contained on its web site at any time without notice. Hollowverse
            does not, however, make any commitment to update the materials.
          </p>
          <h2>6. Links</h2>
          <p>
            Hollowverse has not reviewed all of the sites linked to its Internet
            web site and is not responsible for the contents of any such linked
            site. The inclusion of any link does not imply endorsement by
            Hollowverse of the site. Use of any such linked web site is at the
            user’s own risk.
          </p>
          <h2>7. Site Terms of Use Modifications</h2>
          <p>
            Hollowverse may revise these terms of use for its web site at any
          ...
          <p>
            Any claim relating to Hollowverse’s web site shall be governed by
